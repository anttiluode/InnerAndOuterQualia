...
**The next build** all four papers point at: nested gamma — a handful of refinement steps inside each theta cycle (bounded iteration). It's small and it's motivated. It is not in this version.
